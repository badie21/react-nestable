...
class Nestable extends Component {
	...
	// adding rtl
	onMouseMove = (e) => {
		const { group, threshold, rowDirection } = this.props;
		const { dragItem } = this.state;
	...
	// ––––––––––––––––––––––––––––––––––––
	renderDragLayer() {
		const { group, rowDirection } = this.props;
		const { dragItem } = this.state;
		...
		return (
			<div className="nestable-drag-layer" style={{ direction: 'rtl' }}>
				<ol
					className={
						rowDirection === 'rtl' ? 'nestable-list-rtl' : 'nestable-list'
					}
					style={listStyles}
				>
					<NestableItem
	...
	render() {
		...
		const classes =
			rowDirection === 'ltr'
				...
				: cn(className, 'nestable-rtl', 'nestable-' + group, {
						'is-drag-active': dragItem,
				  });
		return (
			<div className={classes}>
				<ol
					className={
						rowDirection === 'rtl'
							? 'nestable-list-rtl nestable-group'
